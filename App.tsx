...
const App: React.FC = () => {
  ...
  const handleExportExcel = () => {
    ...
    utils.book_append_sheet(wb, matchedSheet, 'Reconciled');
    utils.book_append_sheet(wb, unmatchedSheet, 'Unmatched');
...
const buildMatchedSheet = (result: AnalysisResult) => {
  const headers = ['Policy Number', 'Insured Name', 'Commission Total', 'Override Total', 'Net Total'];
  const data = [
    headers,
...
const buildUnmatchedSheet = (result: AnalysisResult) => {
  const headers = ['Policy Number', 'Insured Name', 'Company', 'Commission Total', 'Override Total', 'Net Total'];
  const data = [
    headers,
